  ...
  return (
    <div >
      ...
      <div className='lg:flex'>
        <div className='w-60'>
          <img className='h-50 w-60' src={Science} alt='Science Image'/>
          <div className='flex items-center text-sm text-gray-500 mt-2'>
            <span> Formula 1 </span>
            <span className="text-center font-bold text-lg leading-none ml-2 mr-2">·</span>
            <span> 3 hours ago </span>
          </div> 
          <h1 className='font-bold text-base mt-2'> 'He Deserves a lot more verstappen  backs alonso' </h1>
          ...
          <p className='flex items-center text-sm text-gray-500 mt-2'> 
            <span className='bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text'> Sport </span>
            <span className="text-center font-bold text-lg leading-none ml-2 mr-2">·</span>
